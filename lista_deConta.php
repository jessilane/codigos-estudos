          ...
          <div class="container">
           ...
           <a class="navbar-brand" href="index.php">J.T restaurant</a>
            ...
            <div id="navbar" class="navbar-collapse collapse">
	  		...
	  		<li  class="active" ><a href="lista_deConta.php">Visualizar Conta Aberta</a>	</li>
                   <?php
...
conta.valor_total,
conta.estado_conta,
mesas.numero_mesas FROM conta,garcom,mesas,hora where conta.id_funci = garcom.id_funci and conta.idMesas = mesas.idMesas and conta.id_hora = hora.id_hora AND garcom.id_funci=$idFunci";
 ...
 while ($row = mysql_fetch_assoc($result_set))
 {
    ...
    <td><?php echo $row['estado_conta'];?></td>   
	 ...
	 <td><a href ="e_conta.php?id=<?php echo $row['id_conta'];?>"><img src="imagem/edit.jpg" width="25" height="25" /></a></td>
     <td><a href ="fecha_conta1.php?id=<?php echo $row['id_conta'];?>"  onclick="return confirm('Você tem certeza que deseja excluir este item?')"> <img src="imagem/yoii (3).png" width="25" height="25" /></a></td>
