...
<?php
	include "banco_restaurante.php";
		...
		$id= $_GET['id'];// gerente selecionado
...
<br>
 ...
 maxlength="10" onBlur= "ValidaDataform1.data);" value="<?php echo $row['data']; ?>"> <p></p>
	<label>Telefone:</label> <input type="text" size="30" id="telefone" name="telefone" onKeyPress="MascaraTelefone(form1.telefone);" maxlength="14"  onBlur="ValidaTelefone(form1.telefone);" value="<?php echo $row['telefone']; ?>"> <p></p>
...
onKeyPress="MascaraRG(form1.rg);" maxlength="14"  value="<?php echo $row['rg']; ?>"><p></p>
...
<label>Email: </label>
 <input type="text" id="email" name="email" size="40" maxlength="40" value="<?php echo $row['email']; ?>" onBlur="ValidaEmail();"><p></p>
<?php
...
<td colspan="4">
				...
				<a href="lista_gerente.php"><input type="button" class="btn btn-success" value="Consultar"> </button><a></center>
					<p></p>
					<a  class="btn btn-danger" href="lista_proprietario.php">Voltar</a>	
...
$email  = $_POST ['email'];
			...
			echo "<script> window.location=\"lista_gerente.php\" </script>";//comando sql
		}
