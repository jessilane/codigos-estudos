...
<div id="page">
	...
	<div id="content">
		<p id="status"></p>
		<form action="proceLogPro.php" method="POST" id="login">
			<fieldset>
				<ul>
					<li>
									<legend>Login do Proprietario</legend>
<center>
<img src="imagem/ftpro.png"  width="70px" height="75px"/>
</center>
<br>
							<label for="login">
					...
					<li>
						<label class="centered info"><a id="forgotpassword" href="#">login e senha...</a>
						</label>
					</li>
				</ul>
			</fieldset>
