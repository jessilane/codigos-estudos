      ...
      <div class="container">
        ...
        <nav class="navbar navbar-inverse navbar-static-top">
         ...
         if(isset($idFunci) and ($_SESSION['perfil']=='admin')){ ?>
                                  ...
                                  <li><a href="lista_cliente2.php">Clientes Cadastrados!</a></li>       <li><a onClick="return confirm('certeza que deseja SAIR?')" href="logoutGa.php">Sair</a></li>
...
<br>
<center>
<p class=" btn-default btn-lg"> Lista de Clientes! <p>
...
<td><a href ="e_cliente2.php?id=<?php echo $row['id_cliente'];?>"><img src="imagem/edit.png" width="25" height="25" /></a></td>
   <td><a href ="apagar_cliente2.php?id=<?php echo $row['id_cliente'];?>"  onclick="return confirm('Você tem certeza que deseja excluir este item?')"><img src="imagem/delete.png" width="25" height="25" /></a></td>
     </tr>
     <?php
 }
 ?>
