        ...
        <nav class="navbar navbar-inverse navbar-static-top">
          <div class="container">
            ...
            <?php
				 ...
				 if(isset($idFunci)){ ?>
                                  <li class="active"><a href="lista_garcom.php">Minha Conta!</a></li>
...
<h2>Olá Funcionario(a)  <?php echo $_SESSION['login_funci'] ?> Veja seus dados!</h2><br>
...
echo "<meta charsert=UTF-8>";
 ...
 while ($row = mysql_fetch_assoc($result_set))
 {
	...
	<td><?php echo $row['email'];?></td>
	 ...
	 <td><a href ="i_mensagem.php?id=<?php echo $row['id_funci'];?>" onClick="return confirm('Você nao pode editar seu cadastro do sistema , mande mensagem para o proprietario. Enviar uma mensagem!')"><img src="imagem/edit.jpg" width="25" height="25" /></a></td>
	 <td><a href ="i_mensagem.php?id=<?php echo $row['id_funci'];?>" onClick="return confirm('Você nao pode se excluir do sistema , mande mensagem para o proprietario. Enviar uma mensagem!')"><img src="imagem/delete.png" width="25" height="25" /></a></td>
		 </tr>
		 <?php
 }
 ?>
