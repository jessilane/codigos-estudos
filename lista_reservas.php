...
$idCliente = $_SESSION['id_cliente'];
 ...
 and reserva_mesas.id_hora = hora.id_hora and reserva_mesas.idMesas = mesas.idMesas AND cliente.id_cliente=$idCliente";
 ...
 while ($row = mysql_fetch_assoc($result_set))
 {
	...
	<td><?php echo $row['numero_mesas'];?></td>
	  ...
	  <td><a href ="e_reservar.php?id=<?php echo $row['id_reserva'];?>"><img src="imagem/edit.png" width="25" height="25" /></a></td>
	 <td><a href ="apagar_reserva.php?id=<?php echo $row['id_reserva'];?>"  onclick="return confirm('Você tem certeza que deseja excluir este item?')"><img src="imagem/delete.png" width="25" height="25" /></a></td>
		 </tr>
		 <?php
 }
 ?>
