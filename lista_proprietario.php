...
<body>
  ...
  <li ><a href="area_pro.php">Área de Administração</a></li>
         ...
         if(isset($idFunci)){ ?>
                                  <li class="active"><a href="lista_proprietario.php">Minha Conta!</a></li>
...
<h2>Olá Proprietario(a)  <?php echo $_SESSION['login_funci'] ?> Veja seus dados!</h2><br>
...
echo "<meta charsert=UTF-8>";
 ...
 while ($row = mysql_fetch_assoc($result_set))
 {
  ...
  <td><?php echo $row['email'];?></td>
   ...
   <td><a href ="e_gerente.php?id=<?php echo $row['id_funci'];?>"><img src="imagem/edit.jpg" width="25" height="25" /></a></td>
   <td><a href ="apagar_garcom.php?id=<?php echo $row['id_funci'];?>" onClick="return confirm('Você deseja se excluir do sistema!')"><img src="imagem/delete.png" width="25" height="25" /></a></td>
     </tr>
     <?php
 }
 ?>
